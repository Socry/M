    ...
    const vm = new Vue({
        ...
        methods: {
                ...
                getRandomMsg(dialog.details)
                    .forEach(content => {
                        this.msgChain = this.msgChain
                            .then(() => delay(700))
                            .then(() => this.sendMsg(content, AUTHOR.ASU));
                    });

                return dialog.nextAsu
                    ? this.appendDialog(dialog.nextAsu)
                    : this.msgChain.then(() => {
                        this.lastDialog = dialog;
                        this.isAsuTyping = false;
                    });
            },
            ...
            getDialog(id) {
                ...
                const dialogs = this.dialogs.fromAsu
            ...
            respond(response) {
                ...
                return this.say(response.content, response.nextAsu);
            },
            ...
            ask(fromUser) {
                ...
                return this.say(content, fromUser.nextAsu);
            },
